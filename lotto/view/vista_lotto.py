...
# Vista di dettaglio di un lotto: stato, salute, date del ciclo, note e azioni.
class Vista_Lotto(Simple_Window):

    # Carica e ridimensiona le immagini del lotto pieno e vuoto.
    def load_imgs(self):
    ...
    # Avvia la raccolta del lotto se possibile e mostra l'esito.
    def raccogli(self):
    ...
    # Avvia la piantumazione del lotto se possibile e mostra l'esito.
    def pianta(self):
    ...
    # Aggiorna salute, stato, fase, date e immagine del lotto; pulisce il messaggio dopo qualche ciclo.
    ...
    # Salva le note del lotto quando cambia il testo del campo.
    def change_note(self):
        self.controller.change_note(self.ui.note_edit.toPlainText())

    # Costruisce la UI, avvia i refresh, carica le note e nasconde i comandi in modalità guest.
