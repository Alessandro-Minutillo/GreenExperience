...
# GUI del serbatoio di CO2: riusa il layout di Ui_Att e ne traduce le etichette.
class Ui_SerbCO2(Ui_Att):
    ...
    def retranslateUi(self, att):
        ...
        self.suggerimento.setText(_translate("att", "Suggerimento: il livello di CO2 consigliato per la coltura "))
        ...
        self.titolo.setText(_translate("att", "Serbatoio di CO2"))
        self.obiettivo.setText(_translate("att", "Livello di CO2 obiettivo (ppm)"))
