...
class Ui_Umid(Ui_Att):
    ...
    def retranslateUi(self, att):
        ...
        self.suggerimento.setText(_translate("att", "Suggerimento: il livello di umidità consigliato per la coltura "))
        ...
        self.titolo.setText(_translate("att", "De/Umidificatore"))
        self.obiettivo.setText(_translate("att", "Livello di umidità obiettivo (%)"))
