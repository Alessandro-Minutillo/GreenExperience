...
# Bacheca delle notifiche sugli attuatori (spenti o fuori dai valori consigliati).
class Vista_Bacheca_Att(Vista_Bacheca):
    ...
    # Sincronizza le notifiche mostrate con lo stato corrente di spegnimento e fuori-range degli attuatori.
